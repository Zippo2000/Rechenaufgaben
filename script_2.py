...
# Erstelle eine ausführliche Anleitung
readme = '''# 📱 Rechenaufgaben App für iPhone
...
print("✓ README.md erstellt mit vollständiger Anleitung!")
print("\n" + "="*70)
print("🎉 PROGRESSIVE WEB APP VOLLSTÄNDIG FERTIG!")
print("="*70)
print("\nErstellte Dateien:")
files = [
    "1. index.html        - Hauptseite der App",
    "2. style.css         - Design und Layout",
    "3. app.js            - JavaScript-Funktionalität",
    "4. sw.js             - Service Worker (Offline-Funktion)",
    "5. manifest.json     - PWA-Konfiguration",
    "6. icon-192.png      - App-Icon (klein)",
    "7. icon-512.png      - App-Icon (groß)",
    "8. README.md         - Vollständige Anleitung"
]
for f in files:
    print(f"   {f}")
...
print("="*70)
print("1. Öffne die Kommandozeile im Ordner mit den Dateien")
print("2. Führe aus: python -m http.server 8000")
print("3. Finde deine IP-Adresse (z.B. 192.168.1.100)")
print("4. Öffne Safari auf dem iPhone: http://DEINE-IP:8000")
print("5. Tippe 'Teilen' → 'Zum Home-Bildschirm'")
print("6. Die App ist jetzt auf deinem iPhone installiert! 🎉")
